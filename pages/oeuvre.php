...
<div class="card bg-dark">
    <div class="card-horizontal bg-dark text-light">
        <div class="img-square-wrapper">
            <img class="" src="./admin/images/<?php print $liste_film[0]->image ?>" alt="Card image cap">
        </div>
        <div class="card-body">
            ...
            <a class="text-danger" href="<?php print $liste_film[0]->video ?>"><p>Regarder</p><i class="fas fa-play"></i></a>
        </div>
    </div>
</div>