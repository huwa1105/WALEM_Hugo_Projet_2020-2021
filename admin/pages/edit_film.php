...
<div class="d-flex justify-content-around text-light">
    <form class="bg-dark text-light container px-5 mx-5" action="<?php print $_SERVER['PHP_SELF']; ?>" method="get">
        ...
        <div class="container">
            ...
            <input type="video" placeholder="Video" value="<?php print $liste_film[0]->video; ?>" class="form-control"
                   id="video" name="video">
        </div>
        <div class="container">
        ...
        <div class="container">
            ...
            <input type="text" value="<?php print $liste_film[0]->image; ?>" placeholder="Image" class="form-control"
                   id="image" name="image">
        </div>
        <div class="container">
